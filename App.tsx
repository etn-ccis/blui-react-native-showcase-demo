    ...
    return (
        <>
            ...
            <BottomSheet show={showBottomSheet} onClose={() => setShowBottomSheet(false)}>
                <Text>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste non nostrum possimus aperiam nesciunt
                    ex et, exercitationem, commodi, soluta dolorum maiores amet recusandae quo. Ducimus numquam tempore
                    distinctio facere! Ipsa?
                </Text>
            </BottomSheet>
        </>
    );
